...
public class ListaCompras {
    public static void main(String[] args) {
        ...
        String[] dados;
        while(true) {
            Compras compra = new Compras("", 0, false);
            ...
            if(dados[0].toUpperCase().equals("FIM")){
                 System.out.println("Fim do programa | " + compras.stream().filter(Compras::isComprado).count() + " itens comprados");
                 break;
            } 
            switch(dados[0].toUpperCase()) {
                ...
                case "A": // Atualização
                    for (Compras c : compras) {
                        if(c.getNome().equals(dados[1]) ) {
                            ...
                            else System.out.println("Item " + dados[1] + " não encontrado ou já comprado!");
                        }
                    }
                    break;
                case "X": // Exclusão
                ...
                case "P": // Lista
                    ...
                    System.out.println("--------------------------------");
                    System.out.println("Total de itens: " + compras.size() + " | Total de itens comprados: " + compras.stream().filter(Compras::isComprado).count());
                    break;
            }
        }
        scanner.close();
